...
export default async function MuralTvPage({
  ...
  const { folgas, solicitacoes, feriados, eventos, hoje } = await dadosDoMural(createAdminClient(), empresaId);
  ...
  return <MuralTv folgas={folgas} solicitacoes={solicitacoes} feriados={feriados} eventos={eventos} hoje={hoje} ajuste={ajuste} />;
}

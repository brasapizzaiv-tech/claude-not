          ...
          {finalizada ? (
            ...
            <>
              ...
              <Link
                ...
                className="rounded-controle border border-borda-forte px-4 py-2 text-sm font-medium text-texto-suave hover:bg-superficie-suave dark:border-borda-forte"
              >
            ...
            <thead className="text-left text-xs font-medium text-texto-fraco">
              <tr>
                ...
                <th className="px-4 py-3 text-right">
                  Em estoque
                  <span className="ml-1 font-normal normal-case text-texto-fraco">
                ...
                return (
                  <Fragment key={cat}>
                    <tr className={algumVisivel ? "" : "hidden"}>
                      ...
                      >
                        {cat}
                        <span className="ml-2 font-normal text-texto-fraco">
                          ({itensCat.length})
                        </span>
                      </td>
                    </tr>
                            ...
                            <div className="flex items-center justify-end gap-1.5">
                              ...
                              {!finalizada && (
                                <button
                                  ...
                                  className="rounded-controle border border-borda-forte px-2 py-1 text-xs font-medium text-texto-suave hover:bg-superficie-suave dark:border-borda-forte"
                                >
                                  0
                                </button>
                              )}
          ...
          <div className="w-full max-w-md rounded-cartao bg-painel-cartao p-5">
            ...
            <div className="mt-3 max-h-56 overflow-y-auto rounded-cartao border border-borda p-2 text-sm">
              {avisoSusp.nomes.map((n) => (
                <div key={n} className="px-1 py-0.5 text-texto-suave">• {n}</div>
              ))}
            </div>
      ...
      {aviso && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded-cartao bg-painel-cartao p-5">
            ...
            <div className="mt-3 max-h-56 overflow-y-auto rounded-cartao border border-borda p-2 text-sm">
              {aviso.faltam.map((n) => (
                <div key={n} className="px-1 py-0.5 text-texto-suave">
                  • {n}
                </div>
              ))}
            </div>
            <div className="mt-4 flex justify-end gap-2">
              ...
              <button
                ...
                disabled={salvando}
                className={`rounded-controle px-4 py-2 text-sm font-medium text-white disabled:opacity-60 ${

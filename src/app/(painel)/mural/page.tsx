...
export default async function MuralPage() {
  ...
  const [{ folgas, solicitacoes, feriados, eventos, hoje }, { data: config }, h] = await Promise.all([
  ...
  return (
    <div className="flex w-full flex-col">
      <Mural folgas={folgas} solicitacoes={solicitacoes} feriados={feriados} eventos={eventos} hoje={hoje} />

# Monta o pacote do agente e gera o instalador (AgenteImpressao-Setup.exe).
...
# nao empacotar config/log/pid de teste
foreach ($f in @("config.json","agente.log","agente.pid")) {
...
& $iscc (Join-Path $root "agente.iss") | Out-Host
